...
OFILES = gba.o font.o main.o gameboard.o images/title.o images/background.o images/powerdot.o images/pacman.o images/pacman_up.o images/pacman_down.o images/pacman_left.o images/pacman_right.o images/inky.o images/pinky.o images/blinky.o images/clyde.o images/blueghost.o
